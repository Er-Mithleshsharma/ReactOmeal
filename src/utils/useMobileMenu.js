...
const useMobileMenu = (resId) => {
    ...
    const FETCH_MENU_URL_MOBILE ="https://thingproxy.freeboard.io/fetch/"+encodeURIComponent("https://www.swiggy.com/mapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=12.9715987&lng=77.5945627&submitAction=ENTER&restaurantId="+resId);
